...
class SchoolColors{
  ...
  static const Color UCVTS = Color.fromARGB(f, 28, 40, 154);
  static const Color Allied = Color.fromARGB(f, 98, 11, 19);
  ...
  static const Color UCTech = Color.fromARGB(f, 252, 194, 126);
}